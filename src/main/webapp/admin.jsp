...
<c:set var="sales"          value="${sessionScope.sales}" />
...
<div class="page-wrapper">
    ...
    <div class="machine-area">
                ...
                <c:choose>
                    <c:when test="${drink.inventory == 0}">
                        <div class="drink-slot no-stock"
                             onclick="selectSlot(${drink.ID}, '${drink.name}', ${drink.price}, ${drink.inventory}, '${drink.temperature}', true)">
                    ...
                    <c:otherwise>
                        <div class="drink-slot ${drink.temperature == 'HOT' ? 'hot' : 'cold'}"
                             onclick="selectSlot(${drink.ID}, '${drink.name}', ${drink.price}, ${drink.inventory}, '${drink.temperature}', false)">
                            <img src="${pageContext.request.contextPath}/images/${drink.ID}.png"
                                 alt="${drink.name}" class="drink-img">
                            <span class="drink-name">${drink.name}</span>
        ...
        <div class="op-btn-area">
            <div class="replenish-group">
                <button class="op-btn replenish-btn" id="replenishBtn"
                        onclick="toggleReplenish()" disabled>補　充</button>
                <!-- 補充プルダウン -->
                <div class="replenish-dropdown" id="replenishDropdown" style="display:none">
                    <form action="${pageContext.request.contextPath}/bending/admin" method="post" id="replenishForm">
                        <input type="hidden" name="action"  value="replenish">
                        <input type="hidden" name="drinkId" id="replenishDrinkId" value="">
                        <select name="count" class="count-select" id="replenishCount">
            ...
            <button class="op-btn custom-btn" id="customBtn"
                    onclick="openCustom()" disabled>カスタム</button>
        </div>
        ...
        <div class="sales-area">
            ...
            <form action="${pageContext.request.contextPath}/bending/admin" method="post" id="collectForm">
    ...
    <div class="info-area">
        ...
        <div class="detail-window" id="detailWindow">
            ...
            <div id="detailView">
                <div class="detail-img-area">
                    <img src="${pageContext.request.contextPath}/images/placeholder.png"
                         alt="" id="detailImg" class="detail-drink-img">
                </div>
            ...
            <div id="customView" style="display:none">
                ...
                <div class="img-slider">
                    ...
                    <img src="${pageContext.request.contextPath}/images/drink1.png"
                         alt="ドリンク画像" id="customImg" class="custom-drink-img">
                    <button type="button" class="slide-btn" onclick="nextImage()">&#9654;</button>
                </div>

                <!-- カスタム入力フォーム -->
                <form action="${pageContext.request.contextPath}/bending/admin" method="post" id="customForm">
                    ...
                    <div class="custom-inputs">
                        ...
                        <div class="custom-row">
                            ...
                            <button type="button" class="temp-toggle-btn" id="tempToggleBtn"
                                    onclick="toggleTemp()">HOT</button>
        ...
        <!-- 戻るボタン -->
        <div class="back-area">
            <a href="${pageContext.request.contextPath}/bending/start">
