...
<c:set var="insertedMoney" value="${sessionScope.insertedMoney != null ? sessionScope.insertedMoney : 0}" />
        ...
        <div class="action-area">
            ...
            <div class="tray" id="tray">
                <c:if test="${not empty gotDrink}">
                    <div class="got-drink">
                        <img src="${pageContext.request.contextPath}/images/${gotDrink.ID}.png"
                             alt="${gotDrink.name}" class="tray-img">
            ...
            <div class="buy-return-area">
                <!-- 買うボタン -->
                <form action="${pageContext.request.contextPath}/bending/consumer" method="post" id="buyForm">
                ...
                <!-- おつりボタン -->
                <form action="${pageContext.request.contextPath}/bending/consumer" method="post">
        ...
        <div class="status-window" id="statusWindow">
            <div class="status-item" id="statusDrinkImg">
                <img src="${pageContext.request.contextPath}/images/placeholder.png"
                     alt="" id="statusImg" class="status-drink-img">
            </div>
